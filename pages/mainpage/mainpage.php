...
<body>
    ...
    <div class="row"  style="padding-bottom:10px">
      ...
      <div class="col-md-6">
        <div class="form-group d-flex align-items-end justify-content-end h-100">
          <button type="button" class="btn btn-primary bg-white mr-2" style="color: black">Buscar</button>
          <button type="button" class="btn btn-secondary bg-white" style="color: black">Filtrar</button>
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="container" style="padding-top:10px">
    <div class="row"  style="padding-bottom:10px">
      ...
      <div class="col-md-3">
        <div class="card">
          <img src="../../assets/Carros/camaro.jpg" class="card-img-top" alt="..." height="150px" width="100px">
          <div class="card-body">
      ...
      <div class="col-md-3">
        <div class="card">
          ...
          <div class="card-body">
            ...
            <p class="card-text">A famosa da Italia!</p>
            <a href="#" class="btn btn-primary">SALVAR</a>
            <a href="#" class="btn btn-secondary">COMPRAR</a>
          </div>
          <div class="card-footer">
